      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="pages/email/inbox.html" class="nav-link">View List</a>
                </li>
          ...
          <!-- <li class="nav-item">
            <a href="pages/apps/calendar.html" class="nav-link">
              <i class="link-icon" data-feather="disc"></i>
              <span class="link-title">Appraisals</span>
            </a>
          </li> -->

          <!-- <li class="nav-item nav-category">Self Service</li>
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="/labs/new" class="nav-link">New Request</a>
                </li>
                <li class="nav-item">
                  <a href="pages/ui-components/badges.html" class="nav-link">My Requests</a>
                </li>
        ...
        @yield('content')
			...
			<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
				<p class="text-muted text-center text-md-left">Copyright © <?php echo date('Y'); ?> <a href="#" target="_blank">HEALTHNEUTRON</a>. All rights reserved</p>
